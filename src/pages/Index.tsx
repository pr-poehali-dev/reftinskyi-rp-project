...
const faqs = [
  {
    q: "Как начать играть?",
    a: "Зайди в Roblox, найди игру «Рефтинский РП» через поиск или перейди по ссылке на нашей странице. Регистрация не нужна — просто заходи и начинай.",
  },
  {
    q: "Игра бесплатная?",
    a: "Да, базовая игра полностью бесплатна. Донат даёт косметические преимущества, но не влияет на баланс — победить можно умом и тактикой.",
  },
  {
    q: "Есть ли возрастные ограничения?",
    a: "Игра рассчитана на аудиторию 13+. Тематика включает мрачную атмосферу, криминальные сюжеты и сложные ролевые ситуации.",
  },
  {
    q: "Как попасть в команду разработчиков?",
    a: "Набор в команду объявляется в нашем Discord. Нужно иметь опыт в Roblox Studio или сценарном деле и активно участвовать в жизни сообщества.",
  },
  {
    q: "Что делать, если кто-то нарушает правила?",
    a: "Пожалуйся в канале #жалобы нашего Discord с доказательствами. Модераторы разберут ситуацию в течение 24 часов.",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-body text-[#a09080] leading-relaxed mb-6">
                  Рефтинский РП — это мрачная ролевая игра в Roblox, где каждый игрок
                  создаёт собственную историю в умирающем городе на краю цивилизации.
                </p>
                <p className="font-body text-[#7a7068] leading-relaxed mb-8">
                  Никто не придёт на помощь. Никто не скажет, что делать. Ты сам выбираешь —
                  стать бандитом, торговцем, охотником или призраком этих улиц. Мир меняется
                  вместе с тобой, и каждое решение оставляет след.
                </p>
