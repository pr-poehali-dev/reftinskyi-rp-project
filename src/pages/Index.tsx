...
const faqs = [
  {
    q: "Как начать играть на сервере?",
    a: "Установите Minecraft Java Edition 1.20.x, подключитесь по IP: reftinsky-rp.ru и следуйте инструкциям регистрации прямо в игре.",
  },
  {
    q: "Нужна ли лицензионная копия игры?",
    a: "Да, для игры на нашем сервере требуется лицензионная версия Minecraft. Мы не поддерживаем пиратские клиенты.",
  },
  {
    q: "Есть ли возрастные ограничения?",
    a: "Сервер рассчитан на игроков 16+. Тематика включает мрачные элементы, насилие и сложные ролевые ситуации.",
  },
  {
    q: "Как попасть в команду?",
    a: "Открытые наборы объявляются в нашем Discord. Нужно иметь минимум 200 часов на сервере и положительную репутацию.",
  },
  {
    q: "Что делать при нарушении правил другими игроками?",
    a: "Подайте жалобу в Discord-сервере в канале #жалобы. Приложите скриншоты или записи. Модераторы рассмотрят в течение 24 часов.",
  },
];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#e0d8d0] scanlines overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ROLEPLAY SERVER ● MINECRAFT JAVA
          </div>
          <h1
          ...
          >
            Выживи. Адаптируйся. Стань легендой этого проклятого места.
          </p>
          <div
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-body text-[#a09080] leading-relaxed mb-6">
                  Рефтинский РП — это атмосферный ролевой сервер Minecraft, где каждый игрок
                  пишет свою историю в умирающем постапокалиптическом городе.
                </p>
                <p className="font-body text-[#7a7068] leading-relaxed mb-8">
                  Здесь нет правых и виноватых. Есть только выжившие, которые борются за
                  ресурсы, территории и собственное выживание. Ваши решения меняют мир вокруг.
                </p>
